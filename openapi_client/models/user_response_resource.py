...
class UserResponseResource(BaseModel):
    """
    UserResponseResource
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The resource's unique identifier")
    href: Optional[StrictStr] = Field(default=None, description="URI for specific Admin in a Contract")
    ...
    __properties: ClassVar[List[str]] = ["id", "href", "firstName", "lastName", "email"]
