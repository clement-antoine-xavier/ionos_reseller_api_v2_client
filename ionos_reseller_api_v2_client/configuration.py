...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "BasicAuthentication": BasicAuthSetting,
        "TokenAuthentication": APIKeyAuthSetting,
    },
    total=False,
)
...
conf = ionos_reseller_api_v2_client.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "/reseller/v2" if host is None else host
        """Default Base url
        """
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        if 'TokenAuthentication' in self.api_key:
