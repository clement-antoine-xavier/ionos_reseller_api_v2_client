...
class ErrorMessage(BaseModel):
    ...
    ErrorMessage
    """ # noqa: E501
    error_code: Optional[StrictStr] = Field(default=None, description="IONOS Cloud error code.", alias="errorCode")
    message: Optional[StrictStr] = Field(default=None, description="Limit must not exceed 5,000.")
